...
public class UpdatePostTest {
	...
	public void updatePostTest() {
		...
		/* sending the post to be updated */
		RestAssured.baseURI = this.url;
		Response response = RestAssured.given().contentType("application/json")
				.body(new File("src/main/resources/Post/update/addPost.json")).post("/PostServlet");
		...
		/* sending the post update request */
		response = RestAssured.given().contentType("application/json")
				.body(new File("src/main/resources/Post/update/updatePost.json")).post("/PostServlet");
		...
		errorCollector.checkThat("Updated content", Matchers.equalTo(this.content));
		errorCollector.checkThat("13", Matchers.equalTo(this.type));
		errorCollector.checkThat("update", Matchers.equalTo(this.pubdate));
	...
	public void getPost() {
		try {
			...
			ResultSet rs = st.executeQuery("select * from aaupush.post where aaupush.post.id='3' ;");
